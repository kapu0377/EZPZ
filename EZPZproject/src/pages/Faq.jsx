...
const Faq = () => {
  ...
  const faqList = [
    {
      id: 12,
      question: "금지물품은 어떤게 있나요?",
      answer: "주요 금지물품 으로는 총기류, 폭발물, 인화성 물질등이 있습니다.\n금지 물품 규정은 항공사 및 국가에 따라 다를 수 있으므로, 여행 전에 반드시 관련 규정을 확인하는 것이 좋습니다."
    },
    {
      id: 13,
      question: "자유 게시판은 어떻게 사용하나요??",
      answer: "회원가입 후 로그인을 하시면 게시글 작성 또는 댓글을 등록할수 있습니다."
    },
    {
      id: 14,
      question: "체크리스트는 어떻게 사용하나요?",
      answer: "회원가입과 로그인을 통해 수하물 정보를 사전에 편리하게 확인할 수 있습니다"
    },
    {
      id: 15,
      question: "주차현황은 어떻게 확인하나요?",
      answer: "주차현황을 누르시면면 각 공항별로 이용 가능한 주차 공간 수를 실시간으로 보실 수 있습니다."
    },
    {
      id: 16,
      question: "회원 탈퇴시 게시글 또는 댓글은 유지가 되나요?",
      answer: "회원 탈퇴 시, 게시글과 댓글은 함께 삭제됩니다."
    },
    {
      id: 1,
